...
public class ProductoController {
    ...
    public List<Producto> listado(Model modelo) throws Exception {
        modelo.addAttribute("titulo", "Listado de Productos con Carro de Compra");
        return productoService.findAll();
    }

    @RequestMapping(value = "/form.htm", method = RequestMethod.GET)
    @ModelAttribute("producto")
    public Producto setupForm(@RequestParam(value = "id", required = false, defaultValue = "0") int id) {
