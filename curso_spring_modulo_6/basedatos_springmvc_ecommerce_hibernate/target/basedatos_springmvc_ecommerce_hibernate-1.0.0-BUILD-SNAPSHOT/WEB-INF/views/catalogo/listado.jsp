...
<body>
	<div class="page-header">
		<h1>
			${titulo}: <small>Ejemplo de base datos Spring MVC eCommerce</small>
		</h1>
	</div>
	<div class="container">
		...
		<p>
			...
			<a class="btn btn-default" href="<c:url value="/carro/ver.htm"/>"
				role="button">Ver Carro</a>
		</p>
							...
							<tbody>
								<c:forEach items="${productos}" var="producto">
									<tr>
										...
										<td><a class="btn-xs btn-success" href="<c:url value="/carro/agregar.htm?id=${producto.id}"/>">agregar al carro</a></td>
